...
export const scene = async () => {
  ...
  out.t("{{artifact}} lies on the ground.", {
    artifact: ui.text.naming.short(artifact),
  })
  out.t(
    "Eldritch tendrils wrap around and snap the artifact into the pocket storage dimension."
  )
