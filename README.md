...
- [ ] Make the weighted sample functions better and have them be based on the seeded rng.
    - [ ] Follow https://docs.python.org/3/library/random.html
    - [ ] Have the weighting be generated by pre-defined for the list of armies. Remove the weight function that gets called every... single... time :(
